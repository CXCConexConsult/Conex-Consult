let vagasDetalhadas = {
    ...
    '<p><strong>Local:</strong> <a href="https://www.microsoft.com">Microsoft</a>, São Paulo/São Paulo</p>' +
    '<p><strong>Tipo de Contrato:</strong> Tempo Integral</p>' +
    '<h2>Resumo da Vaga:</h2>' +
    '<p>Estamos à procura de um Desenvolvedor de Software talentoso e motivado para se juntar à nossa equipe de TI. O candidato ideal deve ter sólida experiência em desenvolvimento de software, excelentes habilidades de resolução de problemas e ser capaz de trabalhar em um ambiente dinâmico e colaborativo.</p>' +
    '<h3>Responsabilidades:</h3>' +
    '<ul>' +
      '<li>Desenvolver, testar e implementar soluções de software de alta qualidade.</li>' +
      '<li>Colaborar com equipes multidisciplinares para definir, projetar e enviar novas funcionalidades.</li>' +
      '<li>Identificar e corrigir problemas de software, garantindo a manutenção de sistemas existentes.</li>' +
      '<li>Participar de revisões de código e garantir que as melhores práticas de desenvolvimento sejam seguidas.</li>' +
      '<li>Manter-se atualizado com as tecnologias emergentes e aplicá-las para melhorar o software existente.</li>' +
    '</ul>' +
    '<h3>Requisitos:</h3>' +
    '<ul>' +
      '<li>Bacharelado em Ciência da Computação, Engenharia de Software ou área relacionada.</li>' +
      '<li>Experiência comprovada em desenvolvimento de software (mínimo de 3 anos).</li>' +
      '<li>Conhecimento profundo de linguagens de programação como Java, C#, Python, ou JavaScript.</li>' +
      '<li>Experiência com frameworks e bibliotecas populares (por exemplo, React, Angular, Spring, .NET).</li>' +
      '<li>Familiaridade com metodologias ágeis (Scrum, Kanban).</li>' +
    ...
    '<h3>Diferenciais:</h3>' +
    '<ul>' +
      '<li>Experiência com desenvolvimento de aplicativos móveis (iOS, Android).</li>' +
      '<li>Conhecimento em DevOps e ferramentas de CI/CD (por exemplo, Jenkins, Docker, Kubernetes).</li>' +
      '<li>Experiência com serviços em nuvem (AWS, Azure, Google Cloud).</li>' +
    ...
    '<p>Interessados devem enviar o currículo atualizado e uma carta de apresentação para <a href="mailto:microsoft@luravell.com">microsoft@luravell.com</a> até <strong>data limite</strong>. Por favor, inclua no assunto do e-mail “Candidatura para Desenvolvedor de Software – [Seu Nome]”.</p>' +
    '<p>Junte-se à Microsoft e impulsione sua carreira na tecnologia!</p>' +
    '<div class="match">' +
      ...
      '<span class="requisitos">IOS</span>' +
      '<span class="requisitos">Android</span>' +
  ...
  '</div>',
    ...
    '<p><strong>Tipo de Contrato:</strong> Tempo Integral</p>' +
    '<h2>Resumo da Vaga:</h2>' +
    '<p>Estamos à procura de um Engenheiro de Dados experiente para se juntar à nossa equipe de análise de dados. O candidato ideal deve ter habilidades avançadas em modelagem de dados e experiência com grandes volumes de dados.</p>' +
    '<h3>Responsabilidades:</h3>' +
    '<ul>' +
      '<li>Desenvolver e manter pipelines de dados eficientes.</li>' +
      '<li>Garantir a integridade e segurança dos dados.</li>' +
      '<li>Colaborar com equipes de desenvolvimento e analistas de dados.</li>' +
      '<li>Implementar e otimizar soluções de armazenamento de dados.</li>' +
      '<li>Monitorar e resolver problemas relacionados aos dados.</li>' +
    '</ul>' +
    '<h3>Requisitos:</h3>' +
    '<ul>' +
      '<li>Bacharelado em Ciência da Computação, Engenharia de Dados ou área relacionada.</li>' +
      '<li>Experiência mínima de 4 anos como Engenheiro de Dados.</li>' +
      '<li>Proeficiência em SQL e linguagens de script (Python, R).</li>' +
      '<li>Experiência com ferramentas de ETL.</li>' +
      '<li>Familiaridade com big data (Hadoop, Spark).</li>' +
      '<li>Excelentes habilidades analíticas e de resolução de problemas.</li>' +
    '</ul>' +
    '<h3>Diferenciais:</h3>' +
    '<ul>' +
      '<li>Experiência com serviços de nuvem (GCP, AWS, Azure).</li>' +
      '<li>Conhecimento em machine learning.</li>' +
      '<li>Certificações relevantes em análise de dados.</li>' +
    '</ul>' +
    '<h3>Benefícios:</h3>' +
    '<ul>' +
      '<li>Salário competitivo.</li>' +
    ...
    '</ul>' +
    '<h2>Como se Candidatar:</h2>' +
    '<p>Interessados devem enviar o currículo atualizado e uma carta de apresentação para <a href="mailto:google@luravell.com">google@luravell.com</a> até <strong>data limite</strong>. Por favor, inclua no assunto do e-mail “Candidatura para Engenheiro de Dados – [Seu Nome]”.</p>' +
    '<p>Junte-se ao Google e faça parte de um time inovador!</p>' +
    '<div class="match">' +
      '<span class="requisitos">SQL</span>' +
      '<span class="requisitos">Python</span>' +
      '<span class="requisitos">R</span>' +
      '<span class="requisitos">ETL</span>' +
      '<span class="requisitos">Hadoop</span>' +
      '<span class="requisitos">Spark</span>' +
      '<span class="requisitos">GCP</span>' +
...
'<div class="ocultar_vaga"> '+
  ...
  '<div id="vaga3" class= "vagaDetalhada">' +
    ...
    '<p><strong>Tipo de Contrato:</strong> Tempo Integral</p>' +
    '<h2>Resumo da Vaga:</h2>' +
    '<p>A Amazon está em busca de um Arquiteto de Soluções para ajudar a projetar e implementar arquiteturas de TI que suportem as necessidades de nossos clientes. O candidato ideal deve ter uma sólida experiência em arquitetura de sistemas e habilidades em liderar projetos de grande escala.</p>' +
    '<h3>Responsabilidades:</h3>' +
    '<ul>' +
      '<li>Desenhar arquiteturas de soluções robustas e escaláveis.</li>' +
      '<li>Trabalhar com clientes para entender suas necessidades e traduzir em requisitos técnicos.</li>' +
      '<li>Colaborar com equipes de desenvolvimento para garantir a implementação correta das soluções.</li>' +
      '<li>Proporcionar orientação técnica e suporte ao longo do ciclo de vida do projeto.</li>' +
      '<li>Manter-se atualizado com as melhores práticas e novas tecnologias de arquitetura de TI.</li>' +
    '</ul>' +
    '<h3>Requisitos:</h3>' +
    '<ul>' +
      '<li>Bacharelado em Ciência da Computação, Engenharia de Software ou área relacionada.</li>' +
      '<li>Experiência mínima de 5 anos em arquitetura de soluções.</li>' +
      '<li>Conhecimento profundo de tecnologias de nuvem (AWS, Azure, GCP).</li>' +
      '<li>Experiência com metodologias de desenvolvimento ágil.</li>' +
      '<li>Excelentes habilidades de comunicação e capacidade de liderança.</li>' +
      '<li>Capacidade de gerenciar múltiplos projetos simultaneamente.</li>' +
    '</ul>' +
    '<h3>Diferenciais:</h3>' +
    '<ul>' +
      '<li>Certificação AWS Certified Solutions Architect.</li>' +
      '<li>Experiência com containers (Docker, Kubernetes).</li>' +
      '<li>Conhecimento em segurança da informação.</li>' +
    '</ul>' +
    '<h3>Benefícios:</h3>' +
    '<ul>' +
      '<li>Salário competitivo.</li>' +
    ...
    '</ul>' +
    '<h2>Como se Candidatar:</h2>' +
    '<p>Interessados devem enviar o currículo atualizado e uma carta de apresentação para <a href="mailto:amazon@luravell.com">amazon@luravell.com</a> até <strong>data limite</strong>. Por favor, inclua no assunto do e-mail “Candidatura para Arquiteto de Soluções – [Seu Nome]”.</p>' +
    '<p>Junte-se à Amazon e lidere a inovação tecnológica!</p>' +
    '<div class="match">' +
      '<span class="requisitos">AWS</span>' +
      '<span class="requisitos">Azure</span>' +
      '<span class="requisitos">GCP</span>' +
      '<span class="requisitos">Docker</span>' +
  ...
  '<div id="vaga4" class= "vagaDetalhada">' +
    ...
    '<p><strong>Local:</strong> <a href="https://www.ibm.com">IBM</a>, Brasília/Distrito Federal</p>' +
    '<p><strong>Tipo de Contrato:</strong> Tempo Integral</p>' +
    '<h2>Resumo da Vaga:</h2>' +
    '<p>A IBM busca um Analista de Segurança da Informação para proteger nossos ativos e garantir a segurança dos dados. O candidato ideal deve ter uma sólida experiência em segurança cibernética e conhecimento profundo de ferramentas e técnicas de segurança.</p>' +
    '<h3>Responsabilidades:</h3>' +
    '<ul>' +
      '<li>Monitorar redes e sistemas em busca de atividades suspeitas.</li>' +
      '<li>Investigar incidentes de segurança e recomendar ações corretivas.</li>' +
      '<li>Desenvolver e implementar políticas de segurança.</li>' +
      '<li>Realizar auditorias de segurança e testes de penetração.</li>' +
      '<li>Trabalhar com equipes de TI para fortalecer a segurança dos sistemas.</li>' +
    '</ul>' +
    '<h3>Requisitos:</h3>' +
    '<ul>' +
      '<li>Bacharelado em Segurança da Informação, Ciência da Computação ou área relacionada.</li>' +
      '<li>Experiência mínima de 3 anos em segurança da informação.</li>' +
      '<li>Conhecimento profundo de firewalls, IDS/IPS e criptografia.</li>' +
      '<li>Experiência com normas e regulamentos de segurança (ISO 27001, GDPR).</li>' +
      '<li>Excelentes habilidades de análise e resolução de problemas.</li>' +
    '</ul>' +
    '<h3>Diferenciais:</h3>' +
    '<ul>' +
      '<li>Certificações em segurança (CISSP, CEH, CompTIA Security+).</li>' +
      '<li>Conhecimento em segurança de redes e aplicação.</li>' +
      '<li>Experiência com SIEM e ferramentas de monitoramento.</li>' +
    '</ul>' +
    '<h3>Benefícios:</h3>' +
    '<ul>' +
      '<li>Salário competitivo.</li>' +
    ...
    '</ul>' +
    '<h2>Como se Candidatar:</h2>' +
    '<p>Interessados devem enviar o currículo atualizado e uma carta de apresentação para <a href="mailto:ibm@luravell.com">ibm@luravell.com</a> até <strong>data limite</strong>. Por favor, inclua no assunto do e-mail “Candidatura para Analista de Segurança da Informação – [Seu Nome]”.</p>' +
    '<p>Junte-se à IBM e ajude a proteger nossos dados!</p>' +
    '<div class="match">' +
      '<span class="requisitos">Firewalls</span>' +
      '<span class="requisitos">IDS/IPS</span>' +
      '<span class="requisitos">Criptografia</span>' +
      '<span class="requisitos">ISO 27001</span>' +
      '<span class="requisitos">GDPR</span>' +
